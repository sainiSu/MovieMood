...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 ">
      ...
      <div className="bg-sky-50 to-white">
        ...
        <main className="p-4 max-w-6xl w-full mx-auto ">
          {movies.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {movies.map((movie) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-base mt-2 text-center">
                    {movie.title}
                  </h3>

                  <p className="text-sm text-gray-600 mt-1 text-center line-clamp-3">
                    {movie.overview}
                  </p>
            ...
            <div className="flex justify-center items-center mt-6 w-full h-[65vh] bg-cover bg-center rounded-lg shadow" style={{ backgroundImage: "url('/movie.jpg')" }}>

              <p className="text-white text-xl font-semibold bg-black bg-opacity-60 px-4 py-2 rounded">
